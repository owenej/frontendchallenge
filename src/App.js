...
function Dashboard() {
  ...
  const  handleClick = async () => {
    ...
    if (currentTime>theirTime){
      let getUrl = 'https://api.exchangeratesapi.io/history?start_at='+datez+'&end_at='+datez+'&base='+baseCurrency;
...
function ChartHistory() {
  ...
  const getUrlTwo = 'https://api.exchangeratesapi.io/history?start_at=2018-01-01&end_at=2018-09-01&symbols=ILS&base=USD';
  try{
